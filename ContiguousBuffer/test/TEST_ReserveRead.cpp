...
TEST_F(TEST_ReserveRead, ReserveReadOperations_ReadAt0) {
...
TEST_F(TEST_ReserveRead, ReserveReadOperations_ReadAt1) {
...
TEST_F(TEST_ReserveRead, ReserveReadOperations_ReadAt2) {
...
TEST_F(TEST_ReserveRead, ReserveReadOperations_ReadAt3) {
...
TEST_F(TEST_ReserveRead, ReserveReadOperations_InvalidStates) {
    ...
    size_t size = 1;
    EXPECT_FALSE(mRingBuffer.ReserveRead(data, size)); // Handle as: buffer empty
    EXPECT_EQ(size, 0);
    EXPECT_EQ(mRingBuffer.Size(), 0);
