...
TEST_CASE( "Ringbuffer TryPop() operations", "[Ringbuffer]" )
{
    ...
    SECTION( "basic operations - read at 0" )
    {
        ...
        REQUIRE(ringBuff.TryPop(data, 0) == false);

        ringBuff.SetState(0, 0);
        REQUIRE(ringBuff.TryPop(data, 1) == false);

        // Default: size == 1
        ringBuff.SetState(0, 0);
        REQUIRE(ringBuff.TryPop(data) == false);
        ...
        REQUIRE(ringBuff.TryPop(data, 1) == true);
        REQUIRE(ringBuff.CheckState(1, 1) == true);

        // Default: size == 1
        ringBuff.SetState(1, 0);
        REQUIRE(ringBuff.TryPop(data) == true);
        REQUIRE(ringBuff.CheckState(1, 1) == true);

        ringBuff.SetState(1, 0);
        REQUIRE(ringBuff.TryPop(data, 2) == false);
        ...
        ringBuff.SetState(2, 0);
        REQUIRE(ringBuff.TryPop(data, 2) == true);
        REQUIRE(ringBuff.CheckState(2, 2) == true);

        ringBuff.SetState(2, 0);
        REQUIRE(ringBuff.TryPop(data, 3) == false);
        ...
        ringBuff.SetState(3, 0);
        REQUIRE(ringBuff.TryPop(data, 3) == true);
        REQUIRE(ringBuff.CheckState(3, 3) == true);

        ringBuff.SetState(3, 0);
        REQUIRE(ringBuff.TryPop(data, 4) == false);
    }
    ...
    SECTION( "basic operations - invalid states" )
    {
        ...
        REQUIRE(ringBuff.TryPop(data, 1) == false);     // Handle as: buffer empty
        // Default: size == 1
        REQUIRE(ringBuff.TryPop(data) == false);
